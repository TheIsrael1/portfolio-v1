  ...
  return (
    <div className="relative flex overflow-hidden items-center justify-center  h-[20px] transform transition-all">
      <div className="flex flex-col justify-between w-[20px] h-[18px] transform transition-all duration-300 origin-center overflow-hidden">
        <div
          className={`bg-white-3 h-[2px] w-5 transform transition-all duration-300 origin-left ${
            menuOpen ? `translate-x-10` : ``
          } delay-50`}
        ></div>
        <div
          className={`bg-white-3 h-[2px] w-5  transform transition-all duration-300 ${
            menuOpen ? `translate-x-10` : ``
          } delay-50`}
        ></div>
        <div
        ...
        >
          <div
            className={`absolute bg-white-3 h-[2px] w-5 transform transition-all duration-300  delay-100 ${
